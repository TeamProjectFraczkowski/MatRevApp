...
public class RevisionTopic3Activity extends BaseActivity{
    ...
    public void goToRevision4(View view) {
        Intent goToRev4act = new Intent(this, RevisionTopic4Activity.class);
        startActivity(goToRev4act);
    }
