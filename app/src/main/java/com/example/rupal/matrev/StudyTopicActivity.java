...
public class StudyTopicActivity extends AppCompatActivity{
    ...
    public void goToStudyTopic2(View view)
    {
        Intent goToTopic2 = new Intent(this, StudyTopic2Activity.class);
        startActivity(goToTopic2);
    }
